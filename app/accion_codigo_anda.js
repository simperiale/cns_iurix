const main = async () => {
    try {
        ...
        // 1) Tomar variable del flujo - Intentar múltiples métodos
        ...
        log("🔄 Consultando expediente: " + numeroExpediente);

        // 2) URL de tu API
        const url = "https://295e78749150.ngrok-free.app/api/bot/webhook";
        ...
        try {
            response = await fetch(url, {
                ...
                body: JSON.stringify({ query: numeroExpediente, numeroExpediente: numeroExpediente }),
